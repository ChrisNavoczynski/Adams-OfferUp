exports.productListing = [
    {
       ...
       available: true,
       price: 140.00,
       description: "Comfy chair for your gaming needs",
       location: {
           visual: "Seattle, WA",
           latitude: 47.5562833,
...

    {
        ...
        available: true,
        price: 450.00,
        description: "6th scale stantion figure",
        location: {
            visual: "Olympia, WA",
            latitude: 47.0530121,
...

    {
        ...
        available: true,
        price: 150.00,
        description: "105QT bin. No instructions or completed sets",
        location: {
...

    {
        ...
        available: true,
        price: 26000.00,
        description: "red, 4WD Trail Edition, New Breaks",
        location: {
...

    {
        ...
        available: true,
        price: 100.00,
        description: "Comicbook collection from the 80s",
        location: {
            visual: "Yakima, WA",
            latitude: 46.5847687,
    ...
    
    {
        ...
        available: true,
        price: 300.00,
        description: "COMPLETE 2nd ed. Planescape Setting BoxSet",
        location: {
            visual: "Kirkland, WA",
            latitude: 47.686113,
...

    {
        ...
        available: true,
        price: 750.00,
        description: "Brand new never opened next gen system",
        location: {
            visual: "Redmond, WA",
            latitude: 47.674794,
